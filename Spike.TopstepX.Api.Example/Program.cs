...
namespace Spike.ProjectX.Api.Example
{
    internal class Program
    {
        ...
        private static ProjectXApi _projectXApi;
        ...
        private static async Task Main(string[] args)
        {
            try
            {
                _tokenStore = new AuthTokenHandler(userName, apiKey, apiEndpoint);
                _token = await _tokenStore.GetToken();
                _projectXApi = new ProjectXApi(userName, apiKey, apiEndpoint);
